...
-- ====================================================================			
	...
	AddItemBag(BAG_DROP, 161, MakeItemID(14,20),1)-- 'Item_(14,455,0)_Small_Gift_Box') -- DropFunction /4/
...
-- ====================================================================
    ...
    AddItemBag(BAG_MONSTER, 363, 0,596)--'Monster_(596)_Hellraiser') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 364, 0,592)--'Monster_(592)_Undine') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 365, 0,593)--'Monster_(593)_Salamander') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 366, 0,594)--'Monster_(594)_Sylphid') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 367, 0,595)--'Monster_(850)_Gnome') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 368, 0,611)--'Monster_(611)_Sellihoden') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 370, 0,778)--'Monster_(778)_DeepGorgon') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 371, 0,275)--'Monster_(275)_Kundun') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 372, 0,716)--'Monster_(716)_Core Magriffi') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 373, 0,795)--'Monster_(795)_Puppy_(Green)') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 374, 0,796)--'Monster_(796)_Puppy_(white)') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 375, 0,797)--'Monster_(797)_Puppy_(purple)') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 376, 0,798)--'Monster_(798)_Puppy_(yellow)') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 377, 0,855)--'Monster_(855)_Rat_(Green)') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 378, 0,856)--'Monster_(856)_Rat_(white)') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 379, 0,857)--'Monster_(857)_Rat_(purple)') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 380, 0,858)--'Monster_(858)_Rat_(yellow)') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 381, 0,817)--'Monster_(817)_Pig_(Green)') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 382, 0,818)--'Monster_(818)_Pig_(white)') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 383, 0,819)--'Monster_(819)_Pig_(purple)') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 384, 0,820)--'Monster_(820)_Pig_(yellow)') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 385, 0,691)--'Monster_(691)_NewYearHorse_(Green)') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 386, 0,692)--'Monster_(692)_NewYearHorse_(Yellow)') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 387, 0,693)--'Monster_(693)_NewYearHorse_(Brown)') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 388, 0,694)--'Monster_(694)_NewYearHorse_(Blue)') -- DropFunction /2/
	--AddItemBag(BAG_MONSTER, 389, 0,673)--'Monster_(673)_Lord_Silvester') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 638, 0,652)--'Golden Goblin(summon the demmon)') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 639, 0,653)--'Golden titan (summon the demmon)') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 640, 0,654)--'Golden tantalose(summon the demmon)') -- DropFunction /2/
...
-- ====================================================================
	...
	AddItemBag(BAG_MONSTER, 644, 46,673)-- 'Monster_(673)_Lord_Silvester') -- DropFunction /3/
	...
	--AddItemBag(BAG_MONSTER, 651, 55,716)-- 'Monster_(716)_Core_Magriffy') -- DropFunction /3/
	AddItemBag(BAG_MONSTER, 652, 56,734)-- 'Monster_(734)_Lord_of_Ferea') -- DropFunction /3/
	AddItemBag(BAG_MONSTER, 653, 57,746)-- 'Monster_(746)_Knicks') -- DropFunction /3/
	AddItemBag(BAG_MONSTER, 654, 58,794)-- 'Monster_(794)_God_of_Darkness') -- DropFunction /3/
	...
	AddItemBag(BAG_MONSTER, 669, 151,560)-- 'Event_Monster_(560)_Sapi_Queen') -- DropFunction /3/ used when OverriteDefaultSettings from MonsterGroupRegen.xml is set to 1
	...
	AddItemBag(BAG_EVENT, 701, 1001,0)-- 'Event_LastManStanding_Winner_Reward') -- DropFunction /3/
	AddItemBag(BAG_EVENT, 702, 1002,0)-- 'Event_LastManStanding_Looser_Reward') -- DropFunction /3/
	AddItemBag(BAG_EVENT, 703, 1004,0)-- 'Event_LastManStanding_Winner_Reward') -- DropFunction /3/
